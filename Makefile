...
FREEBSD_GUESTAGENT_PATH_COMMON = _output/share/lima/lima-guestagent.FreeBSD-
...
FREEBSD_GUESTAGENT_ARCHS = aarch64 riscv64 x86_64
...
ALL_GUESTAGENTS_NOT_COMPRESSED += $(addprefix $(FREEBSD_GUESTAGENT_PATH_COMMON),$(FREEBSD_GUESTAGENT_ARCHS))
endif
...
ifeq ($(CONFIG_GUESTAGENT_OS_FREEBSD),y)
# apply CONFIG_GUESTAGENT_ARCH_*
GUESTAGENTS += $(foreach arch,$(FREEBSD_GUESTAGENT_ARCHS),$(call guestagent_path_enabled_by_config,FREEBSD,$(arch)))
endif
...
ENVS_$(FREEBSD_GUESTAGENT_PATH_COMMON)aarch_64 = CGO_ENABLED=0 GOOS=freebsd GOARCH=arm64
ENVS_$(FREEBSD_GUESTAGENT_PATH_COMMON)riscv64 = CGO_ENABLED=0 GOOS=freebsd GOARCH=riscv64
ENVS_$(FREEBSD_GUESTAGENT_PATH_COMMON)x86_64 = CGO_ENABLED=0 GOOS=freebsd GOARCH=amd64
...
$(LINUX_GUESTAGENT_PATH_COMMON)%.gz: $(LINUX_GUESTAGENT_PATH_COMMON)% $$(call force_build_with_gunzip,$$@)
	@set -x; gzip $<
$(FREEBSD_GUESTAGENT_PATH_COMMON)%.gz: $(FREEBSD_GUESTAGENT_PATH_COMMON)% $$(call force_build_with_gunzip,$$@)
	@set -x; gzip $<
